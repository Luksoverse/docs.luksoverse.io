...
> Within the [monitoring section](/docs/mainnet/complete-node-guide/monitoring/start-here) of this guide you can find further internal communication channels.
